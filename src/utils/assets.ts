...
export const glossary = [
	...
	{
		term: {
			en: 'Burning Pre-Harvest',
			th: 'การเผาก่อนการเก็บเกี่ยว',
		},
		definition: {
	...
	{
		term: {
			en: 'Post-Harvest Residue',
			th: 'เศษซากหลังการเก็บเกี่ยว',
		},
		definition: {
			en: 'The ash and charred material left after burning.',
			th: 'เถ้าถ่านและวัสดุที่เหลือหลังจากการเผา',
		},
	},
	{
		term: {
	...
	{
		term: {
			en: 'Field Heat Intensity',
			th: 'ความร้อนในพื้นที่',
		},
		definition: {
			en: 'The level of heat generated during burning.',
			th: 'ระดับความร้อนที่เกิดขึ้นระหว่างการเผา',
		},
	},
	{
		term: {
		...
		definition: {
			en: 'Mixture of gases and particles released during burning.',
			th: 'ส่วนผสมของก๊าซและอนุภาคที่ปล่อยออกมาในระหว่างการเผา',
		},
	},
	{
		term: {
			en: 'Particulate Matter (PM)',
			th: 'ฝุ่นละออง (PM)',
		},
		definition: {
			en: 'Tiny airborne particles from burning.',
			th: 'อนุภาคขนาดเล็กในอากาศที่เกิดจากการเผา',
		},
	},
	{
		term: {
			en: 'Zero-Burn Harvesting',
			th: 'การเก็บเกี่ยวแบบไม่เผา',
		},
		definition: {
	...
	},
	{
		term: {
			...
			th: 'ดัชนีคุณภาพอากาศ (AQI)',
		},
		definition: {
			en: 'A measure of air quality levels.',
			th: 'ค่าที่ใช้วัดระดับคุณภาพอากาศในแต่ละวัน',
		},
	},
	{
		term: {
			en: 'Crop Residue Burning Policy',
			th: 'นโยบายการเผาเศษซากพืช',
		},
		definition: {
			en: 'Regulations to control or reduce residue burning.',
			th: 'กฎระเบียบที่ควบคุมหรือลดการเผาเศษซากพืช',
		},
	},
	{
		term: {
			en: 'Burnt Sugarcane Yield',
			th: 'ผลผลิตอ้อยเผา',
		},
		definition: {
	...
	{
		term: {
			en: 'Field Accessibility Post-Burn',
			th: 'ความสะดวกในการเข้าถึงพื้นที่หลังเผา',
		},
		definition: {
			en: 'Improved ease of entering fields after burning.',
			th: 'ความง่ายในการเข้าถึงพื้นที่หลังจากการเผา',
		},
	},
	{
		term: {
	...
	},
	{
		term: {
			en: 'Harvestable Area',
			th: 'พื้นที่เก็บเกี่ยวได้',
		},
		definition: {
			en: 'The portion of the cultivated area ready for harvesting.',
			th: 'ส่วนของพื้นที่เพาะปลูกที่พร้อมสำหรับการเก็บเกี่ยว',
		},
	},
	{
		term: {
		...
		definition: {
			en: 'Amount of sugarcane produced per hectare of land.',
			th: 'ปริมาณอ้อยที่ผลิตได้ต่อพื้นที่หนึ่งไร่',
		},
	},
	{
		term: {
			en: 'Productivity Rate',
			th: 'อัตราการผลิต',
		},
		definition: {
			en: 'Efficiency of sugarcane production, calculated as yield per unit area.',
			th: 'ประสิทธิภาพของการผลิตอ้อยคำนวณจากผลผลิตต่อหน่วยพื้นที่',
		},
	},
	{
		term: {
			en: 'Land Classification',
			th: 'การจัดประเภทที่ดิน',
		},
		definition: {
	...
	},
	{
		...
		definition: {
			en: 'Land left unplanted to restore soil fertility.',
			th: 'พื้นที่ที่ไม่ปลูกพืชเพื่อฟื้นฟูความอุดมสมบูรณ์ของดิน',
		},
	},
	{
		term: {
		...
		definition: {
			en: 'A specific plot or area within a sugarcane plantation.',
			th: 'พื้นที่เฉพาะในไร่อ้อย',
		},
	},
	{
		term: {
			en: 'Water Management Area',
			th: 'พื้นที่บริหารจัดการน้ำ',
		},
		definition: {
	...
	},
	{
		term: {
			en: 'GPS Mapping',
			th: 'การทำแผนที่ด้วย GPS',
		},
		definition: {
			en: 'Use of GIS and GPS to define and map sugarcane fields.',
			th: 'การใช้ระบบ GIS และ GPS เพื่อกำหนดและทำแผนที่ไร่อ้อย',
		},
	},
	{
		term: {
	...
	},
	{
		...
		definition: {
			en: 'Defining the physical limits of a sugarcane area.',
			th: 'การกำหนดขอบเขตทางกายภาพของพื้นที่ปลูกอ้อย',
		},
	},
	{
		term: {
			en: 'Crop Rotation Area',
			th: 'พื้นที่หมุนเวียนพืช',
		},
		definition: {
	...
	},
	{
		term: {
			en: 'Mill Supply Area',
			th: 'พื้นที่จัดส่งโรงงาน',
		},
		definition: {
			en: 'Geographical zone assigned to a sugar mill for sourcing.',
			th: 'พื้นที่ทางภูมิศาสตร์ที่จัดสรรสำหรับโรงงานน้ำตาลในการรับอ้อย',
		},
	},
	{
		term: {
		...
		definition: {
			en: 'Regions relying on artificial water systems for growth.',
			th: 'พื้นที่ที่ใช้ระบบน้ำเทียมสำหรับการเพาะปลูก',
		},
	},
	{
		term: {
			en: 'Copernicus Programme',
			th: 'Copernicus Programme',
		},
		definition: {
	...
	{
		term: {
			en: 'Sentinel Missions',
			th: 'Sentinel Missions',
		},
		definition: {
			en: 'A series of satellites under the Copernicus Programme, each focused on specific monitoring tasks.',
			th: 'ชุดดาวเทียมในโครงการ Copernicus โดยแต่ละภารกิจเน้นการสังเกตพื้นที่เฉพาะ',
		},
	},
	{
		term: {
			en: 'SAR (Synthetic Aperture Radar)',
			th: 'SAR (Synthetic Aperture Radar)',
		},
		definition: {
			en: 'A radar system onboard Sentinel-1 that provides high-resolution images regardless of weather or time.',
			th: 'ระบบเรดาร์บน Sentinel-1 ที่ให้ภาพความละเอียดสูงโดยไม่ขึ้นกับสภาพอากาศหรือเวลา',
		},
	},
	{
		term: {
	...
	{
		term: {
			en: 'Multispectral Instrument (MSI)',
			th: 'Multispectral Instrument (MSI)',
		},
		definition: {
	...
	},
	{
		...
		definition: {
			en: 'The resolution of Sentinel-2 images (10m, 20m, 60m bands).',
			th: 'ความละเอียดของภาพจาก Sentinel-2 (10m, 20m, 60m)',
		},
	},
	{
		term: {
		...
		definition: {
			en: 'An index from Sentinel-2 data to assess vegetation health.',
			th: 'ดัชนีจากข้อมูล Sentinel-2 เพื่อประเมินสุขภาพของพืช',
		},
	},
	{
		term: {
	...
	{
		term: {
			en: 'MSI (MultiSpectral Instrument)',
			th: 'MSI (MultiSpectral Instrument)',
		},
		definition: {
	...
	{
		term: {
			en: 'SWIR (Short-Wave Infrared)',
			th: 'SWIR (Short-Wave Infrared)',
		},
		definition: {
	...
	},
	{
		term: {
			...
			th: 'Time-Series Analysis',
		},
		definition: {
			en: 'Analyzing changes over time using multiple Sentinel images.',
			th: 'การวิเคราะห์การเปลี่ยนแปลงตามเวลาโดยใช้ภาพ Sentinel หลายภาพ',
		},
	},
	{
		term: {
	...
	},
	{
		term: {
			...
			th: 'Global Positioning System (GPS)',
		},
		definition: {
			en: 'A satellite-based navigation system used to determine precise locations on Earth.',
			th: 'ระบบนำทางด้วยดาวเทียมที่ใช้ในการหาตำแหน่งที่แม่นยำบนโลก',
		},
	},
	{
		term: {
	...
	{
		term: {
			en: 'InSAR (Interferometric Synthetic Aperture Radar)',
